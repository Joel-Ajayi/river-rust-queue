-- dlq_entries: terminal failures awaiting human attention. source_topic/original_key
-- let the replay worker republish to the correct topic with deterministic partitioning.
