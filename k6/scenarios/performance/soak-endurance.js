...
// Logging thresholds to print elapsed indicators.
...
// Soak testing runs for long durations with moderate VUs.
...
// Track the start timestamp to output hourly indicator logs.
...
export default function (data) {
	...
	// Hourly indicators evaluation block.
	const elapsed = (Date.now() - startTime) / 1000;
	if (elapsed > SOAK_LIMIT_INTERVAL_SEC && elapsed < SOAK_LIMIT_INTERVAL_SEC + SOAK_LIMIT_WINDOW_SEC) {
