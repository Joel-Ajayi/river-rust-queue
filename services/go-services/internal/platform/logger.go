...
const (
	...
	LogEventServerDraining                = "server_draining"
	...
	LogEventRelayServiceDraining          = "relay_service_draining"
	LogEventRelayBatchProcessFailed       = "relay_batch_process_failed"
	LogEventShardDBBreakerOpenPausingPoll = "shard_db_breaker_open_pausing_poll"
	LogEventKafkaBufferFull               = "kafka_buffer_full_pausing_poll"
	LogEventKafkaBufferResumed            = "kafka_buffer_drained_resuming_poll"
	...
	LogEventRelayWorkerError              = "relay_worker_error"
	LogEventKafkaWriterCloseFailed        = "kafka_writer_close_failed"
	...
	LogEventConsumerCommitFailed    = "consumer_commit_failed"
	LogEventConsumerFetchRetry      = "consumer_fetch_retry"
	LogEventConsumerDrainTimeout    = "consumer_drain_timeout"
	LogEventConsumerChannelRefresh  = "consumer_channel_refresh"
	LogEventConsumerCoordinatorStop = "consumer_coordinator_stop"
